...
============================================================
MobileNetV2 is a lightweight network built from depthwise-
separable convolutions -- designed for phones and edge devices.
Trains fast.
...
plt.tight_layout()
plt.savefig("04_sample_images.png", dpi=120)
plt.close()
print("Saved sample grid -> 04_sample_images.png")


# ==========================================================
# Step 5 -- Apply MobileNetV2's own preprocessing
# ==========================================================
...
# ==========================================================
# Step 6 -- Build the model on the MobileNetV2 base
# ==========================================================
...
EPOCHS = 10
print(f"\n{'='*60}")
print(f"  Training MobileNetV2 transfer  --  {EPOCHS} epochs")
print(f"{'='*60}")
history = model.fit(
    train_prep,
...
plt.close()
print("Saved training curves -> 04_training_curves.png")
...
plt.grid(False)
plt.savefig("04_confusion_matrix.png", dpi=120)
plt.close()
print("Saved confusion matrix -> 04_confusion_matrix.png")
...
for images, labels in val_ds.take(1):
    ...
    for i in range(9):
        ...
        plt.axis("off")
plt.tight_layout()
plt.savefig("04_predictions.png", dpi=120)
plt.close()
print("Saved prediction grid -> 04_predictions.png")

print("\n" + "="*60)
print("  Done -- MobileNetV2 Transfer Learning")
print("="*60)
