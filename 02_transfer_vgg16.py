...
============================================================
VGG16 is a classic, very regular architecture: stacks of 3x3
convolutions. Large (~15M params in the base) but easy to explain.
...
plt.tight_layout()
plt.savefig("02_sample_images.png", dpi=120)
plt.close()
print("Saved sample grid -> 02_sample_images.png")


# ==========================================================
# Step 5 -- Apply VGG16's own preprocessing
# ==========================================================
...
# ==========================================================
# Step 6 -- Build the model on the VGG16 base
# ==========================================================
...
EPOCHS = 10
print(f"\n{'='*60}")
print(f"  Training VGG16 transfer  --  {EPOCHS} epochs")
print(f"{'='*60}")
history = model.fit(
    train_prep,
...
plt.legend(); plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("02_training_curves.png", dpi=120)
plt.close()
print("Saved training curves -> 02_training_curves.png")
...
plt.close()
print("Saved confusion matrix -> 02_confusion_matrix.png")
...
for images, labels in val_ds.take(1):
    ...
    for i in range(9):
        ...
        plt.axis("off")
plt.tight_layout()
plt.savefig("02_predictions.png", dpi=120)
plt.close()
print("Saved prediction grid -> 02_predictions.png")

print("\n" + "="*60)
print("  Done -- VGG16 Transfer Learning")
print("="*60)
