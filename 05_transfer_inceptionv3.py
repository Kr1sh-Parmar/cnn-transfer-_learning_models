...
============================================================
InceptionV3 uses inception modules -- parallel convolutions of
different sizes in the same block. Note it expects 299x299 inputs.
...
# ==========================================================
# InceptionV3 requires 299x299 input -- different from the others!
IMG_SIZE   = (299, 299)
BATCH_SIZE = 32
...
plt.tight_layout()
plt.savefig("05_sample_images.png", dpi=120)
plt.close()
print("Saved sample grid -> 05_sample_images.png")


# ==========================================================
# Step 5 -- Apply InceptionV3's own preprocessing
# ==========================================================
...
# ==========================================================
# Step 6 -- Build the model on the InceptionV3 base
# ==========================================================
...
EPOCHS = 10
print(f"\n{'='*60}")
print(f"  Training InceptionV3 transfer  --  {EPOCHS} epochs")
print(f"{'='*60}")
history = model.fit(
    train_prep,
...
plt.legend(); plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("05_training_curves.png", dpi=120)
plt.close()
print("Saved training curves -> 05_training_curves.png")
...
plt.grid(False)
plt.savefig("05_confusion_matrix.png", dpi=120)
plt.close()
print("Saved confusion matrix -> 05_confusion_matrix.png")
...
plt.close()
print("Saved prediction grid -> 05_predictions.png")

print("\n" + "="*60)
print("  Done -- InceptionV3 Transfer Learning")
print("="*60)
