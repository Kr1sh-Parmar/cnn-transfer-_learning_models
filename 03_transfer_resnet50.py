...
============================================================
ResNet50 introduced residual (skip) connections, which let very
deep networks train without the vanishing-gradient problem.
...
plt.tight_layout()
plt.savefig("03_sample_images.png", dpi=120)
plt.close()
print("Saved sample grid -> 03_sample_images.png")
...
EPOCHS = 10
print(f"\n{'='*60}")
print(f"  Training ResNet50 transfer  --  {EPOCHS} epochs")
print(f"{'='*60}")
history = model.fit(
    train_prep,
...
plt.close()
print("Saved training curves -> 03_training_curves.png")
...
plt.grid(False)
plt.savefig("03_confusion_matrix.png", dpi=120)
plt.close()
print("Saved confusion matrix -> 03_confusion_matrix.png")
...
for images, labels in val_ds.take(1):
    ...
    for i in range(9):
        ...
        plt.axis("off")
plt.tight_layout()
plt.savefig("03_predictions.png", dpi=120)
plt.close()
print("Saved prediction grid -> 03_predictions.png")

print("\n" + "="*60)
print("  Done -- ResNet50 Transfer Learning")
print("="*60)
